...
if __name__ == '__main__':
    ...
    if TUNING:
        cost_factors_arr = []
        cost_factors_arr.append({"time": 0.01, "velocity": 0.0, "acceleration": 0.0, "jerk": 0., "heading":10, "angular_velocity": 0.01,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
        cost_factors_arr.append({"time": 0.01, "velocity": 0.0, "acceleration": 0.0, "jerk": 0., "heading":10, "angular_velocity": 0.1,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
        cost_factors_arr.append({"time": 0.01, "velocity": 0.0, "acceleration": 0.0, "jerk": 0., "heading":10, "angular_velocity": 1,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
        cost_factors_arr.append({"time": 0.01, "velocity": 0.0, "acceleration": 0.0, "jerk": 0., "heading":10, "angular_velocity": 10,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
        cost_factors_arr.append({"time": 0.01, "velocity": 0.0, "acceleration": 0.0, "jerk": 0., "heading":10, "angular_velocity": 100,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
