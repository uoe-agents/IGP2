...
def run_experiment(cost_factors: Dict[str, float] = None, use_priors: bool = True, max_workers: int = None):
    ...
    for SCENARIO in SCENARIOS:
        ...
        Maneuver.LON_SWERVE_DISTANCE = 6
...
if __name__ == '__main__':
    ...
    if TUNING:
        ...
        cost_factors_arr.append({"time": 0.001, "acceleration": 0.0, "jerk": 0., "heading":10, "angular_velocity": 0.0,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
        cost_factors_arr.append({"time": 0.001, "acceleration": 0.0, "jerk": 0., "heading":100, "angular_velocity": 0.0,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
        cost_factors_arr.append({"time": 0.001, "acceleration": 0.0, "jerk": 0., "heading":1000, "angular_velocity": 0.0,
                            "angular_acceleration": 0., "curvature": 0.0, "safety": 0.})
