...
from igp2.carla.agents.navigation.basic_agent import BasicAgent
from igp2.carla.agents.navigation.local_planner import RoadOption
from igp2.carla.agents.navigation.behavior_types import Cautious, Aggressive, Normal
from igp2.carla.agents.tools.misc import get_speed, positive, is_within_distance, compute_distance
...
class BehaviorAgent(BasicAgent):
    ...
    def __init__(self, agent_id: int, initial_state: AgentState, vehicle: carla.Actor, behavior='normal'):
        """
        Constructor method.
        ...
        Args:
            ...
            behavior: type of agent to apply
        """

        super(BehaviorAgent, self).__init__(agent_id, initial_state, vehicle)
    ...
    def run_step(self, debug: bool = False) -> carla.VehicleControl:
        ...
        Returns:
            A pair of control for this agent, and the type of action taken.
        """
