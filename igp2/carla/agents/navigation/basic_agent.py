...
from igp2.carla.agents.navigation.local_planner import LocalPlanner
from igp2.carla.agents.navigation.global_route_planner import GlobalRoutePlanner
from igp2.carla.agents.tools.misc import get_speed, is_within_distance, get_trafficlight_trigger_location
...
class BasicAgent(Agent):
    ...
    def __init__(self,
        ...
        Args:
            agent_id: ID of the current agent (IGP2)
            initial_state: Initial state of the agent (IGP2)
            vehicle: actor to apply to agent logic onto
            target_speed: speed (in m/s) at which the vehicle will move
            opt_dict: dictionary in case some of its parameters want to be changed.
                This also applies to parameters related to the LocalPlanner.
        """
        super(BasicAgent, self).__init__(agent_id, initial_state)
        ...
        self._target_speed = target_speed * 3.6  # BasicAgent uses km/h
